<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Project_ThayTri.Account.Login" %>
                        ...
                        <div class="content__box">
                            <div class="box-item">
                                <div class="box-item-dk">
                                    <h3 class="box__text-center" style="margin: 30px 0 40px;">Đăng Nhập Tài Khoản</h3>
                                    <asp:Label ID="lb_error" CssClass="text-danger" runat="server"></asp:Label>
                                    <form class="form_box" action="">
                                        <div class="form_input">
                                            <label for="lb_username"  style="font-size: 18px; "><span style="color: red">* </span>Tên đăng nhập</label>
                                        ...
                                        <div class="form_input">
                                            <asp:Button CssClass="btn btn-outline-dark" style="background-color: #ffc59e" ID="button" runat="server" OnClick="handleClickDangNhap" Text="Đăng Nhập Tài khoản" />
                                        </div>
                                    ...
                                    <p class="box__text-sub">— Hoặc đăng nhập với —</p>
                                    ...
                                    <form class="box-footer" action="" style="margin-bottom: 20px;">
                                        <div style="color: red; font-size: 18px;"><span><a href="#">Đăng Ký </a></span>|<span><a href="../TrangChu.aspx"> Trang Chủ</a></span></div>
                                    </form>
                                </div>
                            </div>
                        </div>
